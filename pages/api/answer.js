...
const SYSTEM_PROMPTS = {
	...
	SKINCARE: {
		MESSAGE: {
			'role': 'system',
			'content': 'Pretend that you are passionate about skincare products',
		},
		TEMPERATURE: 1,
		MAX_TOKENS: 100,
		TYPE: 'skincare',
...
const converse = (res, messages, type) => {
	switch (type) {
		...
		case SYSTEM_PROMPTS.SKINCARE.TYPE:
			return converseChat(res, messages, SYSTEM_PROMPTS.SKINCARE);
		default:
